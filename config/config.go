...
func init() {
	...
	cfg.SetDefault("analyzer.topology.ovn.nb.address", "unix:///var/run/ovn/ovnnb_db.sock")
	cfg.SetDefault("analyzer.topology.ovn.sb.address", "unix:///var/run/ovn/ovnsb_db.sock")
